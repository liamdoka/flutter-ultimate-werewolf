...
class _LobbyModel implements LobbyModel {
  const _LobbyModel({required this.id, this.admin, final  List<GameCard> deck = const [GameCard.bluSpy, GameCard.soldier, GameCard.soldier, GameCard.soldier, GameCard.soldier], this.state = LobbyState.waiting, this.discussionTime = 90, final  List<PlayerModel> players = const []}): _deck = deck,_players = players;
